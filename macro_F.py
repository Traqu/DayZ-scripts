...
def key_press_handler(event):
    if event.name == 'a' or event.name == 'w' or event.name == 's' or event.name == 'd' or event.name == 'esc' or event.name == 'space' or event.name == 'shift' or event.name == 'alt' or event.name == 'tab':
        stop_execution()
